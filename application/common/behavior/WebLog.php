...
class WebLog
{
    ...
    const OS = 'os';
    const BROWSER = 'browser'; // 用户id
    const URL = 'url'; // 用户ip
    const MODULE = 'module'; // 用户地点，通过ip查询
    const CONTROLLER = 'controller'; // 操作系统
    const ACTION = 'action'; // 浏览器
    const METHOD = 'method'; // 请求地址
    const DATA = 'data'; // 模块
    const CREATE_AT = 'create_at'; // 控制器
    /**
     * @var array 配置信息
     */
     ...
     */
    protected static $param = []; // 请求方式
    /**
     * @var array 请求的数据
     */
    protected static $data = []; // 数据
    /**
     * @var bool 是否禁用当前日志记录，禁用后不记录当前日志
     */
    protected static $forbid = false; // 请求时间
